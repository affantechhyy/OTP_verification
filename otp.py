...
server.login("mohdaffan1254@gmail.com","ezxm hvgh xfei jhnf")

body = "dear"+name+","+"\n"+"\n"+"your OTP is "+str(OTP)+"."
subject = "OTP verification using python"
message = f'subject:{subject}\n\n{body}'

server.sendmail("mohdaffan1254@gmail.com",valid_receiver_email,"Your OTP is: ")
...
def sending_otp(receiver_email):
    ...
    subject = "OTP verification using python" 
    message = f'subject:{subject}\n\n{body}'
    server.sendmail("mohdaffan1254@gmail.com",receiver_email,message)
